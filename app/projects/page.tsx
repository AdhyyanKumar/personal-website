...
const projects = [
  ...
  },
  {
    ...
    description: 'Full-stack e-commerce admin dashboard with real-time analytics, inventory management, and order tracking.',
  ...
  },
  {
    ...
    description: 'Beautiful weather application with 7-day forecasts, location-based services, and interactive maps.',
    image: 'https://images.pexels.com/photos/1118873/pexels-photo-1118873.jpeg?auto=compress&cs=tinysrgb&w=800',
    tech: ['React', 'OpenWeather API', 'CSS3', 'Geolocation API'],
    category: 'Frontend',
    year: '2023',
    status: 'Live',
    featured: false,
  },
  {
    ...
    description: 'Modern, responsive portfolio website built with Next.js, featuring smooth animations and optimized performance.',
